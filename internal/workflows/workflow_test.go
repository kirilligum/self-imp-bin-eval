...
func registerActivityNames(env *testsuite.TestWorkflowEnvironment) {
	...
	env.RegisterActivityWithOptions(func(context.Context, activities.GenerateQuestionsInput) (activities.GenerateQuestionsResult, error) {
		return activities.GenerateQuestionsResult{}, nil
	}, activity.RegisterOptions{Name: activities.ActivityGenerateQuestions})
